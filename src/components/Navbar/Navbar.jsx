        ...
        <nav className="py-4 2xl:px-6">
            <div className="container flex items-center justify-between">
                ...
                <ul className="hidden md:flex items-center space-x-6">
                    ...
                    <Link to="/add-book" className="cursor-pointer" href="AddBook.html" id="lws-addBook">
                        <li>Add Book</li>
                    </Link>
                </ul>
                ...
                <form className="flex items-center">
                    <div className="group relative rounded-md bg-white">
                        ...
                        <input onChange={(e) => handleSearchValue(e.target.value)} type="text" placeholder="Filter books..." className="search" id="lws-search" />
                    </div>
                </form>
            </div>
        </nav>
